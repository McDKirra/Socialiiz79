...
import {ISocialiiz79State} from './ISocialiiz79State';
...
export function creatEntryTypeChoices(parentProps:ISocialiiz79Props , parentState: ISocialiiz79State, _onChange){
